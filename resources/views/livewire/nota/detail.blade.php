<div>
    <div class="content-wrapper" style="padding: 2rem 3rem;">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex">
                <a href="{{ route('pdf.index', ['ids' => $nota->id]) }}" target="_blank"
                    class="btn btn-sm btn-warning mr-4">
                    <i class="fas fa-print mr-1"></i> Print
                </a>

                <div class="text-center mr-4">
                    <button type="button" wire:click="toggleCek({{ $nota->id }})" wire:loading.attr="disabled"
                ...
                <div class="text-center mr-4">
                    <button type="button" wire:click="togglePrint({{ $nota->id }})" wire:loading.attr="disabled"
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="d-flex mb-2">
                                ...
                                <input type="text" wire:model="no_nota" class="form-control form-control-sm mr-5"
                                    readonly>
                            </div>
                            ...
                            <div class="d-flex mb-2">
                                ...
                                <span class="mx-2">:</span>
                                <input type="date" wire:model="jt_tempo" class="form-control form-control-sm mr-5">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="d-flex mb-2">
                                ...
                                <span class="mx-2">:</span>
                                <input type="text" wire:model="pembeli" class="form-control form-control-sm mr-5">
                            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($editIndex === $index)
                                        ...
                                        <textarea id="nama-barang-{{ $index }}"
                                            style="width: 100%; min-height: 34px; resize: none; overflow: hidden; " rows="1"
                                            wire:model="editData.nama_barang"></textarea>
                                    @else
                                        {{ $detail->nama_barang }}
                                    @endif
                                </td>
                                    ...
                                    @if ($editIndex === $index)
                                        @foreach ((array) ($editData['diskon'] ?? []) as $d => $val)
                                            <div class="d-flex align-items-center mb-1">
                                                <input type="number" class="form-control me-1 mr-2"
                            ...
                            <tr class="table-info">
                                ...
                                <td>
                                    <input type="number" class="form-control form-control-sm"
                                        wire:model="newItem.harga" placeholder="Harga">
                                    @error('newItem.harga')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </td>
                                ...
                                <td>
                                    @foreach ((array) ($newItem['diskon'] ?? []) as $d => $val)
                                        <div class="d-flex align-items-center mb-1">
                                            <input type="number" class="form-control form-control-sm me-1 mr-2"
                                                wire:model="newItem.diskon.{{ $d }}" placeholder="%">
